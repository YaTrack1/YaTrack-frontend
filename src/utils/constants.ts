...
export const MENU_BTN = [{i: 1, menu: 'Подходящие кандидаты'}, {i:2, menu: 'Избранное'}, {i: 3, menu:'Приглашенные'}];
export const CARD_LIST=[{},{},{},{},{},{},{},{},{},{},{},{}];
export const CARD_LIST_BUTTONS = [{submenu: 'Активные', color: '#FFF9D3'}, {submenu: 'Максимальное совпадение', color: ' rgba(255, 191, 253, 0.87)'} , {submenu: 'Проявившие интерес', color: '#ACCCFF'}];
export const LIKE_LIST_BUTTONS = [{submenu: 'Принято', color: '#C2E5CE'}, {submenu: 'Отказ', color: '#FFDDE5'}, {submenu: 'Ожидание', color: '#FFF9D3'}];
