        ...
        <Toolbar sx={{ width: 1440 }}>
          {isLoggedIn ? (<><IconButton><SvgIcon sx={{width: '45px', height: '45px', ml: '25px', mr: '70px'}} component={logo} inheritViewBox onClick={handleClick}></SvgIcon></IconButton>
           ...
           Иванова Анна
            ...
            <IconButton sx={{mr: 2}} color='inherit'><NotificationsActiveOutlinedIcon/></IconButton></>) : (<IconButton><SvgIcon sx={{width: '45px', height: '45px', ml: '25px', mr: '70px'}} component={logo} inheritViewBox></SvgIcon></IconButton>)}
        </Toolbar>
      </AppBar>
    </Box>
  );
