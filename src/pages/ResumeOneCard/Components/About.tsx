  ...
  return (
    <Box sx={{width: '50%'}}>
      <SectionWrapper title='О себе'>
        <p className={styles.about__text}>Меня зовут Анна, и я являюсь графическим дизайнером с болеечем 10-летним стажем работы в этой области. Моя карьера началасьс обучения на факультете графического дизайна в одном из ведущих вузов страны, где я получила фундаментальные знания и навыки,которые стали основой моего профессионального развития.
