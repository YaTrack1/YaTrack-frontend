  ...
  return (
    <Box sx={{ display: 'flex', pr: '30px' }}>
      ...
      <Box sx={{ flexGrow: 1, mr: '20px', width: '100%' }}>
        ...
        >
          <Typography
            sx={{ fontSize: '34px', ml: '24px' }}
            variant='h1'
            component='div'
          >
            Опубликованные вакансии
          </Typography>
          <CreateVacancyBtn onClick={handleOpenModalCreateVacancy}>
        ...
        <List sx={{ mr: 3, pt: '0' }}>
          {vacancies.map((vacancy) => (
            ...
            >
              <CardVacancy
                handleRedVacancyOpen={handleRedVacancyOpen}
      ...
      <ModalForForm open={openModalDelete} onClose={handleCloseModalDelete}>
        <SvgIconClass onClick={handleCloseModalDelete} disableRipple>
          <SvgIcon
        ...
        <Typography
          sx={{ fontSize: '24px', textAlign: 'center', width: '600px' }}
          variant='h6'
          component='h2'
        >
        ...
        >
          ...
          <DeleteStyleButton
            onClick={() => handleDeleteVacancy(titleModal)}
            sx={{ width: '100%' }}
          >
            Удалить
          </DeleteStyleButton>
      ...
      <CreateVacancyFormSteps
        submitNewVacancy={submitNewVacancy}
        open={openModalCreateVacancy}
        onClose={handleCloseModalCreateVacancy}
      />
      <ChangeVacancyForm
        open={openRedForm}
        vacancyForRed={vacancyForRed}
        onClose={handleCloseModalRedVacancy}
      />
    </Box>
  );
};
